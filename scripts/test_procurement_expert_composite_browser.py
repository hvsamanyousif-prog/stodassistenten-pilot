...
# numbered/lettered/bullet/parenthesized list markers are semantic-segmentation
...
# punctuation or list siblings, and ambiguous repeated-modal prose remain one
...
CASES = [
    ...
    {
        'id':'repeated-modal-ordinary-nar-context-still-segments-independently',
        'text':'Leverantören ska ha ansvarsförsäkring och leverantören ska ha ISO 9001-certifikat när avtalet börjar.',
        'expected_rows':2,
        'expect_composite':False,
        'segmented':True,
    },
    ...
    {
        'id':'same-line-parenthesized-lettered-list-segments-independently',
        'text':'(a) Leverantören ska ha ansvarsförsäkring (b) Leverantören ska ha ISO 9001-certifikat.',
        'expected_rows':2,
        'expect_composite':False,
        'segmented':True,
    ...
    {
        'id':'same-line-parenthesized-numbered-list-segments-independently',
        'text':'(1) Pris ska anges i bilaga 6 (2) Sista anbudsdag är 2026-10-30 klockan 23:59.',
        'expected_rows':2,
        'expect_composite':False,
        'segmented':True,
    ...
    {'id':'same-line-parenthesized-alternative-stays-relational-fail-closed','text':'(1) Leverantören ska ha ansvarsförsäkring (2) alternativt ska leverantören ha likvärdigt försäkringsskydd.','category':'qualification','expected_rows':1,'expect_composite':True,'expect_relation':'villkor eller undantag'},
    {'id':'same-line-numbered-either-or-stays-relational-fail-closed','text':'1) Leverantören ska antingen ha ISO 9001-certifikat 2) eller visa ett likvärdigt certifikat.','category':'qualification','expected_rows':1,'expect_composite':True,'expect_relation':'villkor eller undantag'},
    {'id':'same-line-parenthesized-either-or-stays-relational-fail-closed','text':'(1) Leverantören ska antingen ha ISO 9001-certifikat (2) eller visa ett likvärdigt certifikat.','category':'qualification','expected_rows':1,'expect_composite':True,'expect_relation':'villkor eller undantag'},
    ...
    {'id':'repeated-modal-when-conditional-stays-relational-fail-closed','text':'Leverantören ska ha ansvarsförsäkring och när underleverantör används ska underleverantören ha ansvarsförsäkring.','category':'qualification','expected_rows':1,'expect_composite':True,'expect_relation':'villkor eller undantag'},
