...
SCENARIOS = [
    ...
    {
        "id": "sv-self-study-child-target-relative-wins",
        "lang": "sv",
        "width": 390,
        "text": "Jag är student och söker bidrag för mitt barn.",
        "expect_question": False,
    ...
    {
        "id": "sv-self-employee-child-target-relative-wins",
        "lang": "sv",
        "width": 768,
        "text": "Jag är anställd och söker bidrag för min dotter.",
        "expect_question": False,
        "expect_actor": "relative",
    ...
    {
        "id": "ar-self-study-child-target-relative-wins",
        "lang": "ar",
        "width": 1024,
        "text": "أنا طالب وأبحث عن دعم مالي لابني.",
        "expect_question": False,
        "expect_actor": "relative",
        "reject_actor": "study",
        "expect_intent": "funding",
    ...
    {
        "id": "fa-self-employee-child-target-relative-wins",
        "lang": "fa",
        "width": 1280,
        "text": "من کارمند هستم و برای فرزندم کمک مالی می‌خواهم.",
        "expect_question": False,
        "expect_actor": "relative",
        "reject_actor": "employee",
        "expect_intent": "funding",
