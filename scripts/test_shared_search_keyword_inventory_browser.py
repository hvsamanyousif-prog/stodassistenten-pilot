...
SCENARIOS = [
    ...
    {
        "id": "sv-third-party-student-funding-asks-actor",
        "lang": "sv",
        "width": 390,
        "text": "Min syster är student och jag söker bidrag.",
        "expect_question": True,
        "question_token": "vem",
        "expect_intent": "funding",
    },
    {
        "id": "sv-self-student-positive",
        "lang": "sv",
        "width": 1280,
        "text": "Jag är student och söker bidrag.",
        "expect_question": False,
        "expect_actor": "study",
        "expect_intent": "funding",
    },
    {
        "id": "ar-third-party-student-funding-asks-actor",
        "lang": "ar",
        "width": 390,
        "text": "ابني طالب وأنا أبحث عن دعم مالي.",
        "expect_question": True,
        "question_token": "من",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "fa-third-party-student-funding-asks-actor",
        "lang": "fa",
        "width": 390,
        "text": "همسرم دانشجو است و من به کمک مالی نیاز دارم.",
        "expect_question": True,
        "question_token": "چه کسی",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "fa-self-student-positive",
        "lang": "fa",
        "width": 1280,
        "text": "من دانشجو هستم و به کمک مالی نیاز دارم.",
        "expect_question": False,
        "expect_actor": "study",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "ar-third-party-property-actor-funding-asks-actor",
        "lang": "ar",
        "width": 390,
        "text": "مالك العقار رفض طلبي وأنا أبحث عن دعم مالي.",
        "expect_question": True,
        "question_token": "من",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "ar-self-property-actor-positive",
        "lang": "ar",
        "width": 1280,
        "text": "أنا مالك العقار وأبحث عن دعم مالي.",
        "expect_question": False,
        "expect_actor": "property_actor",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "fa-third-party-property-actor-funding-asks-actor",
        "lang": "fa",
        "width": 390,
        "text": "مالک ساختمان درخواست من را رد کرد و من به کمک مالی نیاز دارم.",
        "expect_question": True,
        "question_token": "چه کسی",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "fa-self-property-actor-positive",
        "lang": "fa",
        "width": 1280,
