...
SCENARIOS = [
    ...
    },
    {
        ...
        "lang": "sv",
        "width": 390,
        "text": "Jag hjälper inte längre någon och söker bidrag.",
        "expect_question": True,
        "question_token": "vem",
        "expect_intent": "funding",
    },
    ...
    },
    {
        ...
        "lang": "sv",
        "width": 1024,
        "text": "Jag hjälper min syster och söker bidrag.",
        "expect_question": False,
...
SCENARIOS.extend([
    {
        "id": "sv-clean-start-current-company",
        "lang": "sv",
        "width": 390,
        "text": "Jag är företagare och söker bidrag.",
        "expect_question": False,
        "expect_actor": "company",
        "expect_intent": "funding",
    },
    {
        "id": "sv-clean-start-negated-company-asks-once",
        "lang": "sv",
        "width": 768,
        "text": "Jag är inte längre företagare och söker bidrag.",
        "expect_question": True,
        "question_token": "vem",
        "expect_intent": "funding",
    },
    {
        "id": "sv-clean-start-negated-company-new-student-wins",
        "lang": "sv",
        "width": 1024,
        "text": "Jag är inte längre företagare, jag är student och söker stipendium.",
        "expect_question": False,
        "expect_actor": "study",
        "reject_actor": "company",
        "expect_intent": "scholarship",
    ...
    {
        "id": "sv-clean-start-current-study",
        "lang": "sv",
        "width": 1280,
        "text": "Jag studerar och söker bidrag.",
        "expect_question": False,
        "expect_actor": "study",
        "expect_intent": "funding",
    },
    {
        "id": "sv-clean-start-negated-study-asks-once",
        "lang": "sv",
        "width": 390,
        "text": "Jag studerar inte längre och söker bidrag.",
        "expect_question": True,
        "question_token": "vem",
        "expect_intent": "funding",
    },
    {
        "id": "sv-clean-start-negated-study-new-company-wins",
        "lang": "sv",
        "width": 768,
        "text": "Jag studerar inte längre, jag är företagare och söker bidrag.",
        "expect_question": False,
        "expect_actor": "company",
        "reject_actor": "study",
        "expect_intent": "funding",
    ...
    {
        "id": "ar-clean-start-current-association",
        "lang": "ar",
        "width": 390,
        "text": "أنا في جمعية وأبحث عن تمويل.",
        "expect_question": False,
    ...
    {
        "id": "ar-clean-start-negated-association-asks-once",
        "lang": "ar",
        "width": 768,
        "text": "لم أعد في جمعية وأبحث عن تمويل.",
        "expect_question": True,
    ...
    {
        "id": "ar-clean-start-negated-association-new-student-wins",
        "lang": "ar",
        "width": 1024,
        "text": "لم أعد في جمعية، أنا طالب الآن وأبحث عن منحة دراسية.",
        "expect_question": False,
    ...
    {
        "id": "fa-clean-start-current-association",
        "lang": "fa",
        "width": 390,
        "text": "من عضو انجمن هستم و به کمک مالی نیاز دارم.",
        "expect_question": False,
    ...
    {
        "id": "fa-clean-start-negated-association-asks-once",
        "lang": "fa",
        "width": 768,
        "text": "دیگر عضو انجمن نیستم و به کمک مالی نیاز دارم.",
        "expect_question": True,
    ...
    {
        "id": "fa-clean-start-negated-association-new-student-wins",
        "lang": "fa",
        "width": 1024,
        "text": "دیگر عضو انجمن نیستم، من دانشجو هستم و دنبال بورسیه هستم.",
        "expect_question": False,
    ...
    {
        "id": "ar-request-first-third-party-property-asks-once",
        "lang": "ar",
        "width": 390,
    ...
    {
        "id": "fa-request-first-third-party-property-asks-once",
        "lang": "fa",
        "width": 768,
        "text": "درخواست من را مالک ساختمان رد کرد و به کمک مالی نیاز دارم.",
        "expect_question": True,
        "question_token": "درخواست",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "ar-clean-start-current-property-self",
        "lang": "ar",
        "width": 1024,
        "text": "أنا مالك العقار وأبحث عن تمويل.",
        "expect_question": False,
    ...
    {
        "id": "fa-clean-start-current-property-self",
        "lang": "fa",
        "width": 1280,
        "text": "من مالک ساختمان هستم و به کمک مالی نیاز دارم.",
        "expect_question": False,
