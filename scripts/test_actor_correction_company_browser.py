...
SCENARIOS.extend([
    ...
    {
        "id": "sv-clean-start-third-party-company-asks-once",
        "lang": "sv",
        "width": 390,
        "text": "Min syster är företagare och jag söker bidrag.",
        "expect_question": True,
        "question_token": "vem",
        "expect_intent": "funding",
    },
    {
        "id": "fa-clean-start-current-company-kasbokar",
        "lang": "fa",
        "width": 390,
        "text": "من کسب‌وکار دارم و به کمک مالی نیاز دارم.",
        "expect_question": False,
        "expect_actor": "company",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "fa-clean-start-third-party-company-asks-once",
        "lang": "fa",
        "width": 390,
        "text": "خواهرم کسب‌وکار دارد و من به کمک مالی نیاز دارم.",
        "expect_question": True,
        "question_token": "درخواست",
        "expect_intent": "funding",
        "expect_rtl": True,
...
SCENARIOS.extend([
    {
        "id": "sv-company-target-positive",
        "lang": "sv",
        "width": 390,
        "text": "Jag söker bidrag för mitt företag.",
        "expect_question": False,
        "expect_actor": "company",
        "expect_intent": "funding",
    },
    {
        "id": "sv-company-target-excluded-asks-once",
        "lang": "sv",
        "width": 768,
        "text": "Jag söker bidrag, men inte för mitt företag.",
        "expect_question": True,
        "question_token": "vem",
        "expect_intent": "funding",
    },
    {
        "id": "sv-company-target-excluded-student-wins",
        "lang": "sv",
        "width": 1024,
        "text": "Jag söker bidrag, men inte för mitt företag. Jag är student.",
        "expect_question": False,
        "expect_actor": "study",
        "reject_actor": "company",
        "expect_intent": "funding",
    ...
    {
        "id": "ar-company-target-positive",
        "lang": "ar",
        "width": 390,
        "text": "أبحث عن دعم مالي لشركتي.",
        "expect_question": False,
        "expect_actor": "company",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "ar-company-target-excluded-asks-once",
        "lang": "ar",
        "width": 768,
        "text": "أبحث عن دعم مالي، لكن ليس لشركتي.",
        "expect_question": True,
        "question_token": "من",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "ar-company-target-excluded-student-wins",
        "lang": "ar",
        "width": 1024,
        "text": "أبحث عن دعم مالي، لكن ليس لشركتي. أنا طالب.",
        "expect_question": False,
        "expect_actor": "study",
        "reject_actor": "company",
        "expect_intent": "funding",
    ...
    {
        "id": "fa-company-target-positive",
        "lang": "fa",
        "width": 390,
        "text": "برای شرکت من کمک مالی می‌خواهم.",
        "expect_question": False,
        "expect_actor": "company",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "fa-company-target-excluded-asks-once",
        "lang": "fa",
        "width": 768,
        "text": "کمک مالی می‌خواهم، اما نه برای شرکت من.",
        "expect_question": True,
        "question_token": "درخواست",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "fa-company-target-excluded-student-wins",
        "lang": "fa",
        "width": 1024,
        "text": "کمک مالی می‌خواهم، اما نه برای شرکت من. من دانشجو هستم.",
        "expect_question": False,
        "expect_actor": "study",
        "reject_actor": "company",
        "expect_intent": "funding",
