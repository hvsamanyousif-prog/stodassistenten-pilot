...
EXTRA_SCENARIOS = [
    ...
    {
        "id": "fa-student-karmand-generic-funding-order-parity",
        "lang": "fa",
        "width": 390,
        "text": "من دانشجو و کارمند هستم و به کمک مالی نیاز دارم.",
        "expect_question": True,
        "question_token": "درخواست",
        "expect_intent": "funding",
        "expect_rtl": True,
    ...
    {
        "id": "fa-student-shaghel-generic-funding-order-parity",
        "lang": "fa",
        "width": 1280,
        "text": "من دانشجو و شاغل هستم و به کمک مالی نیاز دارم.",
        "expect_question": True,
        "question_token": "درخواست",
        "expect_intent": "funding",
        "expect_rtl": True,
