...
SCENARIOS = [
    ...
    {
        "id": "sv-helper-person-som-pronoun-hon-rent",
        "text": "Personen som jag hjälper söker bidrag. Hon har hög hyra.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "Finansiering",
        "expect_general_route": False,
    ...
    {
        "id": "sv-neighbour-helper-funding-preserves-housing-need",
        "text": "Jag hjälper min granne att söka bidrag. Hon har hög hyra.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "Finansiering",
        "expect_general_route": False,
    ...
    {
        "id": "sv-neighbour-indefinite-helper-funding-preserves-housing-need",
        "text": "Jag hjälper en granne att söka bidrag. Hon har hög hyra.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "Finansiering",
        "expect_general_route": False,
    ...
    {
        "id": "sv-friend-indefinite-helper-funding-preserves-housing-need",
        "text": "Jag hjälper en vän att söka bidrag. Hon har hög hyra.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "Finansiering",
        "expect_general_route": False,
    ...
    {
        "id": "ar-helper-person-ana-pronoun-hu-rent",
        "lang": "ar",
        "text": "أنا أساعد صديقي. الشخص الذي أنا أساعده يبحث عن دعم مالي. هو لديه إيجار مرتفع.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تمويل",
        "need_context": {"housing"},
    ...
    {
        "id": "ar-neighbour-helper-funding-preserves-housing-need",
        "lang": "ar",
        "text": "أنا أساعد جارتي في البحث عن دعم مالي. هي لديها إيجار مرتفع.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تمويل",
        "need_context": {"housing"},
    ...
    {
        "id": "ar-neighbour-indefinite-helper-funding-preserves-housing-need",
        "lang": "ar",
        "text": "أنا أساعد جارًا في البحث عن دعم مالي. هو لديه إيجار مرتفع.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تمويل",
        "need_context": {"housing"},
    ...
    {
        "id": "ar-friend-indefinite-helper-funding-preserves-housing-need",
        "lang": "ar",
        "text": "أنا أساعد صديقًا في البحث عن دعم مالي. هو لديه إيجار مرتفع.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تمويل",
        "need_context": {"housing"},
    ...
    {
        "id": "fa-helper-person-man-pronoun-ou-rent",
        "lang": "fa",
        "text": "من به دوستم کمک می‌کنم. فردی که من کمک می‌کنم دنبال کمک مالی است. او اجاره بالایی دارد.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تأمین مالی",
        "need_context": {"housing"},
    ...
    {
        "id": "fa-neighbour-helper-funding-preserves-housing-need",
        "lang": "fa",
        "text": "من به همسایه‌ام برای پیدا کردن کمک مالی کمک می‌کنم. او اجاره بالایی دارد.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تأمین مالی",
        "need_context": {"housing"},
    ...
    {
        "id": "fa-neighbour-indefinite-helper-funding-preserves-housing-need",
        "lang": "fa",
        "text": "من به یک همسایه برای پیدا کردن کمک مالی کمک می‌کنم. او اجاره بالایی دارد.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تأمین مالی",
        "need_context": {"housing"},
    ...
    {
        "id": "fa-friend-indefinite-helper-funding-preserves-housing-need",
        "lang": "fa",
        "text": "من به یک دوست کمک می‌کنم تا کمک مالی پیدا کند. او اجاره بالایی دارد.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تأمین مالی",
        "need_context": {"housing"},
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="stod-generic-person-pronoun-") as tmp:
        ...
        evidence = {
            ...
            "independent_semantic_cases": 9,
            "language_parity_variants": len(SCENARIOS) - 9,
