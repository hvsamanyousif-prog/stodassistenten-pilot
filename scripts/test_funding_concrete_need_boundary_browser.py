...
CASES = [
    ...
    {
        "id": "ar-already-received-scholarship-is-not-current-intent",
        "lang": "ar",
        "text": "لقد حصلت بالفعل على منحة. الآن لدي إيجار مرتفع.",
        "expect_question": False,
        "expect_first": "actor_type=private_person",
        "expect_need": "need_context=housing",
        "reject_intent": "funding_intent=",
    ...
    {
        "id": "fa-already-received-scholarship-is-not-current-intent",
        "lang": "fa",
        "text": "من قبلاً بورسیه گرفته‌ام. الان اجاره بالایی دارم.",
        "expect_question": False,
        "expect_first": "actor_type=private_person",
        "expect_need": "need_context=housing",
        "reject_intent": "funding_intent=",
    ...
    {
        "id": "ar-current-scholarship-search-remains-current-intent",
        "lang": "ar",
        "text": "أبحث عن منحة",
        "expect_question": True,
        "expect_first": "actor_type=private_person",
    ...
    {
        "id": "fa-current-scholarship-search-remains-current-intent",
        "lang": "fa",
