...
compatible pronoun-owned need is carried forward. Covered helper surfaces include
direct verb targets plus already-governed Swedish prepositional and Arabic ombud
targets. Raw situation text must never cross the route; only the existing bounded
need_context categories may survive.
...
SCENARIOS = [
    ...
    {
        "id": "sv-helper-preposition-for-her-pronoun-rent",
        "text": "Jag söker bidrag för henne. Hon har hög hyra.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "Finansiering",
        "expect_general_route": False,
    ...
    {
        "id": "sv-helper-preposition-at-him-pronoun-essential",
        "text": "Jag söker bidrag åt honom. Han behöver medicin.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "Finansiering",
        "expect_general_route": False,
    ...
    {
        "id": "sv-helper-preposition-helper-self-not-reassigned",
        "text": "Jag söker bidrag för henne. Jag behöver medicin.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "Finansiering",
        "expect_general_route": False,
    ...
    {
        "id": "sv-helper-preposition-switch-not-reassigned",
        "text": "Jag söker bidrag för henne. Min mamma har hög hyra.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "Finansiering",
        "expect_general_route": False,
    ...
    {
        "id": "ar-helper-on-behalf-her-pronoun-rent",
        "lang": "ar",
        "text": "أبحث عن دعم مالي نيابة عنها. هي لديها إيجار مرتفع.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تمويل",
        "need_context": {"housing"},
    ...
    {
        "id": "ar-helper-on-behalf-him-pronoun-essential",
        "lang": "ar",
        "text": "أبحث عن دعم مالي نيابة عنه. هو يحتاج إلى دواء.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تمويل",
        "need_context": {"essential_costs"},
    ...
    {
        "id": "ar-helper-on-behalf-her-helper-self-not-reassigned",
        "lang": "ar",
        "text": "أبحث عن دعم مالي نيابة عنها. أنا أحتاج إلى دواء.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تمويل",
        "need_context": set(),
    ...
    {
        "id": "ar-helper-on-behalf-her-switch-not-reassigned",
        "lang": "ar",
        "text": "أبحث عن دعم مالي نيابة عنها. أمي لديها إيجار مرتفع.",
        "actor_type": "relative",
        "intent": "funding",
        "context_token": "تمويل",
        "need_context": set(),
