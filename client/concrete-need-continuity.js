...
const RELATIVE_SUBJECTS=[
 ...
 {key:'person',explicit:/(?:personen (?:som )?jag hjälper|jag hjälper (?:henne|honom)|الشخص الذي (?:أنا )?أساعده|(?:بال)?نيابة عن شخص|فردی که (?:من )?کمک|برای او)/i,pronoun:/(?:\b(?:hen|hon|han)\b|(?:^|\s)(?:هي|هو|او)(?:\s|$))/i}
];
...
if(installed){
 root.StodConcreteNeedContinuity=Object.freeze({version:'1.3.9',page});
}
})(window);
