(function (root, factory) {
  ...
  const CONTEXTS = new Set(['near_relative_benefit', 'municipal_support']);
  ...
  const COPY = {
    ...
    ar: {
      ...
      eyebrow: 'دعم شخص قريب', titleBenefit: 'يبدو أنك تحتاج إلى البقاء بجانب شخص مريض جداً', titleMunicipal: 'يبدو أنك ترعى أو تدعم شخصاً قريباً',
      ...
      sourceFk: 'Försäkringskassan: دعم شخص مريض جداً', sourceSol: 'البرلمان السويدي: قانون الخدمات الاجتماعية، الفصل 13 §9', sourceGuide: '1177: دعم الأقارب وطريقة التواصل',
    },
    fa: {
      ...
      eyebrow: 'حمایت از نزدیکان', titleBenefit: 'به نظر می‌رسد لازم است کنار فردی که بسیار بیمار است باشی', titleMunicipal: 'به نظر می‌رسد از یک فرد نزدیک مراقبت یا حمایت می‌کنی',
      ...
      sourceFk: 'Försäkringskassan: حمایت از فرد بسیار بیمار', sourceSol: 'پارلمان سوئد: قانون خدمات اجتماعی، فصل ۱۳ ماده ۹', sourceGuide: '1177: حمایت از نزدیکان و راه تماس',
    },
  };
  ...
  function addShellHandoff(win) {
    ...
    const enhance = () => {
      ...
      title.textContent = context === 'municipal_support' ? copy.shellMunicipalTitle : copy.shellBenefitTitle;
      const sub = doc.createElement('small');
      sub.textContent = context === 'municipal_support' ? copy.shellMunicipalSub : copy.shellBenefitSub;
  ...
  function addPersonGuidance(win) {
    ...
    function render() {
      ...
      const title = doc.createElement('h2'); title.id = 'relativeCareTitle'; title.textContent = context === 'municipal_support' ? copy.titleMunicipal : copy.titleBenefit;
