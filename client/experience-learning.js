(() => {
  ...
  const copy={
    ...
    fa:{title:'به ما کمک کنید پیشنهادها را بهتر کنیم',useful:'آیا پیشنهادها مفید بودند؟',clear:'آیا قدم بعدی روشن بود؟',newq:'آیا چیز جدیدی یاد گرفتید؟',yes:'بله',no:'نه',send:'ارسال بازخورد ناشناس',note:'شرح شرایط شما ارسال نمی‌شود.',needAnswers:'پیش از ارسال به هر سه پرسش بالا پاسخ دهید.',sent:'ممنون — بازخورد ذخیره شد.',error:'فعلاً ارسال بازخورد ممکن نیست.'}
  };
