(function(root){
'use strict';
const APP_VERSION='procurement-expert-0.2.36';
...
function structureFlags(line){
 ...
 const boundedEventUsageConditional=relationLeadingUsageEvent(t)||/\bnär\b[^.;]{0,80}(?:används|anlitas|åberopas)\b/.test(t);
