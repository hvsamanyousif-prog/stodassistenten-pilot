(() => {
  ...
  const energyCopy={
    sv:{
      ...
      qOwner:'Äger du småhuset och bor du där permanent?',
      ...
      ownerNoBody:'Den aktuella Villaeffekten-vägen har villkor om ägande och permanent boende. Ett nej här betyder inte att andra energiråd eller stöd saknas. Kontrollera aktuell Boverket-information och använd kommunal energi- och klimatrådgivning för andra möjliga åtgärder.',
      ownerUnsureTitle:'Bekräfta ägande och permanent boende först',
      ownerUnsureBody:'Den uppgiften kan ändra vägen. Kontrollera den innan du går vidare med bidragsplanering.',
    ...
    ar:{
      ...
      qOwner:'هل تملك المنزل الصغير وتسكن فيه بشكل دائم؟',
      ...
      ownerNoBody:'للمسار الحالي شروط مرتبطة بالملكية والسكن الدائم. هذا لا يعني عدم وجود نصائح أو مسارات طاقة أخرى. تحقق من Boverket واستخدم استشارة الطاقة والمناخ البلدية للبدائل.',
      ownerUnsureTitle:'تحقق أولاً من الملكية والسكن الدائم',ownerUnsureBody:'هذه المعلومة قد تغيّر المسار، لذلك أكدها قبل التخطيط للمنحة.',
    ...
    fa:{
      ...
      qOwner:'آیا مالک خانه هستید و به طور دائم در آن زندگی می‌کنید؟',
      ...
      ownerNoTitle:'Villaeffekten را در این وضعیت مسیر تأییدشده نشان ندهید',ownerNoBody:'مسیر فعلی شرط‌هایی درباره مالکیت و سکونت دائم دارد. این پاسخ به معنی نبودن راهنمایی یا مسیر انرژی دیگر نیست. اطلاعات فعلی Boverket را بررسی کنید و برای گزینه‌های دیگر از مشاوره انرژی و اقلیم شهرداری استفاده کنید.',
      ownerUnsureTitle:'ابتدا مالکیت و سکونت دائم را روشن کنید',ownerUnsureBody:'این اطلاعات می‌تواند مسیر را تغییر دهد؛ پیش از برنامه‌ریزی برای کمک آن را تأیید کنید.',
