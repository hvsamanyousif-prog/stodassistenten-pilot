...
| Person med funktionsnedsättning | root + syn/assistans/familj → samma personmodul | funktionsbehov, bostad, hjälpmedel och assistans hålls isär från diagnos; v31 låser 30-årsövergången som source-aware scenario utan att låtsas att en specialroute redan är publik | ja för visade vägar; ny post för sjukpenning i särskilda fall ligger `NEEDS_REVIEW` | ja för befintliga publika vägar | ja | ja, inklusive v31 aktivitetsersättning→30-årsövergång och boendestödsgräns | lokal/regional variation för hjälpmedel och kommunala insatser kräver fortsatt source-aware routing; 30-årsövergången har nu sannings- och regressionsskydd men saknar fortfarande fokuserad publik handoff och får inte markeras som löst |
...
- arbetsskada/tandvård/försäkringsgränser
...
Arbetsskada + tandvård v27 är ett permanent exempel på samma eval → sanningslager → publik produkt-princip. v26 gav en review-gated sanningspost och regression, men först v27 låter samma root-skal förstå en avgränsad naturlig berättelse om faktisk tandskada i arbete eller på arbetsresan och lämna över endast `actor_type=employee`, `focus=work_injury_dental` och språk. Vanlig tandvärk hos en anställd får inte trigga specialvägen. Personmodulen frågar först var skadan uppstod, därefter om trafikolycka endast när svaret är arbetsresa, sedan om behandlingen behövs på grund av just skadan och slutligen om kostnadsunderlag/tandläkaranslutning. För en trafikolycka på arbetsresan ska Försäkringskassans separata arbetsskadeprövning hållas isär från Afa:s kollektivavtalsgräns och trafikförsäkring; produkten får inte gissa ansvarigt trafikförsäkringsbolag. Rå skadeberättelse, arbetsgivare, exakt kostnad och hälsodetaljer följer inte med i handoff eller feedback. Supportposten ligger fortsatt på `NEEDS_REVIEW`.
...
Aktivitetsersättning → 30-årsövergång v31 är ett permanent exempel på att en förutsägbar åldersgräns kan kräva flera separata vägar utan att produkten får välja åt användaren. Scenario Lab håller aktivitetsersättning, sjukersättning och sjukpenning i särskilda fall isär och förbjuder automatisk konvertering. För specialfallsspåret ska tidigare aktivitetsersättning, SGI-läge, skydd av rätten och aktuell arbetsförmåga bara frågas när de kan ändra vägen. Bostadstillägg och boendetillägg får inte behandlas som samma förmån eller ett automatiskt fortsatt beslut. Den nya sanningsposten för sjukpenning i särskilda fall ligger `NEEDS_REVIEW`, och täckningsmatrisen markerar uttryckligen att en fokuserad publik handoff ännu saknas i stället för att låtsas att eval-täckning är en färdig produktförmåga.
